        ...
        <InViewMotion>
          <div className={styles.box}>
            ...
            <Accordion heading={'営業職からエンジニアになった理由'}>
              <div className={styles.textContainer}>
                <p>
                  ...
                  <br />
                  例えば、ある製造業の会社は独自の加工技術を持っていましたが、Webサイトがないために、その強みを広く伝えられずにいました。
                </p>
                <p>
                  Webサイトがないがゆえに、与信チェックが困難となり問い合わせをいただいても取引に至らないケースが少なくありませんでした。
                  <br />
                  優れた商品やサービスを持っているにもかかわらず、インターネット上で情報を得られないために、ビジネスチャンスを逃してしまっていました。
                </p>
                <p>
                  そこで私はITの力を活用してWebサイトの構築や運用を支援することで、自社の強みを効果的に発信し、潜在顧客とのコミュニケーションを促進させ、
                  <br />
                  企業の認知度向上と新規顧客獲得につなげられるのではないかと考えました。
                </p>
                <p>
                  こうした問題意識から、私はエンジニアへのキャリアチェンジを決意しました。
                  <br />
                  営業職で培った顧客目線の視点と課題分析力にエンジニアとしての技術力を組み合わせることで、企業の価値を最大限に引き出しビジネスの成長を支援できるようになりたと思いました。
                </p>
              </div>
            </Accordion>
            ...
            <Accordion heading="Web制作からWeb開発の分野へ挑戦したい理由">
              <div className={styles.textContainer}>
                <p>
                  Web制作の仕事に従事していますが、より広範囲の企業やユーザーの課題解決に携わりたいという想いから、Reactを使ったWebアプリ開発へのキャリアチェンジを目指しています。
                </p>
                <p>
                  ...
                  <br />
                  例えば、社内の業務効率化や在庫管理の最適化など、より複雑で高度な問題を解決するには、Webアプリケーションの開発が必要だと考えいます。
                </p>
                <p>
                  Reactは、大規模なアプリケーションの開発と保守を効率的に行うことができます。
                  <br />
                  また、Reactの豊富なエコシステムを活用することで、高品質なアプリケーションを短期間で開発することも可能だと思いました。
                </p>
                <p>
                  Web制作で培ったデザイン思考やユーザー目線の考え方は、Webアプリ開発でも非常に重要だと考えています。
                  <br />
                  UIデザインの知識と開発のスキルを組み合わせることで、ユーザーにとって価値のあるアプリケーションを提供できるはずです。
                </p>
                <p>
                  以上のような理由から、私はWeb制作からReactを使ったWebアプリ開発の分野に挑戦したいと考えています。
                  <br />
                  デザインと開発の両方の視点を持つエンジニアとして、企業の課題解決に貢献し、ユーザーに喜ばれるプロダクトを生み出していきたいです。
                </p>
              </div>
            </Accordion>
          </div>
