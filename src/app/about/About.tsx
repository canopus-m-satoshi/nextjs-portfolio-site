        ...
        <InViewMotion>
          <div className={styles.box}>
            ...
            <Accordion heading="Web制作からWeb開発の分野へ挑戦したい理由">
              <div className={styles.textContainer}>
                <p>
                  現在、Web制作の仕事に従事していますが、より広範囲の企業やユーザーの課題解決に携わりたいという想いから、Reactを使ったWeb開発へのキャリアチェンジを目指しています。
                </p>
                <p>
                  ...
                  <br />
                  例えば、社内の業務効率化や在庫管理の最適化など、より複雑で高度な問題を解決するには、Webアプリケーションの開発が必要だと考えます。
                </p>
                <p>
                ...
                <p>
                  以上の理由から、私はWeb制作からReactを使ったWeb開発の分野に挑戦したいと考えています。
                  <br />
